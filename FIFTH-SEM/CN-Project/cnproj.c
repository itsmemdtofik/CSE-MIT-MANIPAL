...
int main()
{
	...
	printf("Starting...\n");
	printf("Destination Mac Address\tSource Mac Address\tDestination Device Type\tSource Device Type\n");
	...
	close(sock_raw);
	printf("\nRecord of 100 Pairs of Source & Destination Printed SUCCESSFULLY!!....Finished\n\n");	
	return 0;
}
...
//Getting device type based on vendor's mac oui.
...
void print_ethernet_header(unsigned char* Buffer, int Size)
{
	...
	//Calling getType to check the type of device.
